...
class NeuralNetwork:
    ...
    def predict(self, x):
            ...
            # Output handling: classification -> softmax, regression -> linear
    ...
    def backward( self, y):
        ...
        # Activation derivative for hidden layers
        ...
        for i in range(len(self.W) - 2, -1, -1):            
            ...
            delta *= derivative(self.A[i+1])  # is this right? or is it A[i]?
...
#-------------------------------------------------------------
            ...
            if self.type == 'classification':
                train_loss = -np.mean(np.sum(y * np.log(y_pred + 1e-15), axis=1))
