...
def train_val_test_split_per_class(X, y, train_frac=0.6, val_frac=0.2, random_state=None):
    # 60/20/20 stratified split: split each class separately so every
    # class is represented in the same proportion in train/val/test
